...
% chw 2018.7.6 
% 一旦instances对象构造完成，其属性信息则不能更改
% 具体见 http://weka.sourceforge.net/doc.stable/weka/core/Instances.html#Instances-java.lang.String-weka.core.FastVector-int-

fastVector = weka.core.FastVector();
%instances = weka.core.Instances(name,fastVector,size(data,1));

% CELL MATRIX ATTRIBUTES
if iscell(data)
 % ADDING ATTRIBUTES
...
% ADDING ATTRIBUTES INFORMATION
instances = weka.core.Instances(name,fastVector,size(data,1));

% CELL MATRIX ADDING OBSERVATIONS
if iscell(data)         
    % ADDING OBSERVATIONS
    for i = 1:size(data,1)
